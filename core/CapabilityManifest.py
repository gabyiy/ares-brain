...
def build_single_turn_voice_pipeline_manifest() -> CapabilityManifest:
    return CapabilityManifest(
        ...
        consumed_contracts={
            ...
            CONTRACT_TRANSCRIPT_NORMALIZATION_RESULT: [CONTRACT_VERSION_V1],
            CONTRACT_VOICE_COMMAND_RESULT: [CONTRACT_VERSION_V1],
            CONTRACT_TEXT_TO_SPEECH_RESULT: [CONTRACT_VERSION_V1],
        },
        produced_contracts={
            CONTRACT_SINGLE_TURN_VOICE_RESULT: [CONTRACT_VERSION_V1],
            CONTRACT_TRANSCRIPT_NORMALIZATION_REQUEST: [CONTRACT_VERSION_V1],
    ...
    return [
        ...
        CapabilityManifest(
            ...
            metadata={
                ...
                "uses_arecord": True,
                "voice_activity_detection": "adaptive_pcm_frame_rms_hysteresis",
                "ambient_calibration": True,
