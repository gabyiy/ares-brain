...
- No real voice/audio implementation beyond the safe VoiceService placeholder, microphone adapter abstraction, speech-to-text adapter abstraction, null input/output components, and one-shot VoiceLoop text bridge.
