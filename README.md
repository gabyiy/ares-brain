...
ARES v2.11 - Continuous Persistent PCM Transport
...
Deterministic tests prove raw lifecycle interception, safe phrase normalization/rejection, ordinary-command fallthrough, CoreService bypass for controls, session clearing/reactivation, explicit shutdown, source-local EOF handling, and persistent-loop continuation. They do not prove what the Raspberry Pi Whisper binary will hear; the lifecycle-only command remains the bounded owner-run hardware proof.
